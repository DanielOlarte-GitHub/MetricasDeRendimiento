...
*/
    ...
    */
    ...
    std::vector<float> nuevaLista (lista_costos.begin(), lista_costos.end());
    std::cout << "\n\nLISTA COSTOS: " << std::endl;

    /*for (double recorrer: lista_costos){
        std::cout << recorrer <<std::endl;
    }*/

    extraerData.vector_to_file(nuevaLista, "FICHERITO.txt");
